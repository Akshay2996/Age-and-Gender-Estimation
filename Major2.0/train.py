...
from wide_resnet2 import WideResNet
...
def get_args():
    ...
    parser.add_argument("--input", "-i", type=str, default="dataset_training.mat",
...
def main():
    ...
    model.compile(optimizer=sgd, loss=["categorical_crossentropy", "categorical_crossentropy", "categorical_crossentropy"],
                  metrics=['accuracy'])
    ...
    if use_augmentation:
        ...
        training_generator = MixupGenerator(X_train, [y_train_g, y_train_a, y_train_r], batch_size=batch_size, alpha=0.2,
                                            datagen=datagen)()
        ...
        hist = model.fit(X_train, [y_train_g, y_train_a, y_train_r], batch_size=batch_size, epochs=nb_epochs, callbacks=callbacks,
                         validation_data=(X_test, [y_test_g, y_test_a, y_test_r]))
